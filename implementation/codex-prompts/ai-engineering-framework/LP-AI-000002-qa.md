...
Run QA only after independent review approves LP-AI-000002 with a complete response compliant with `docs/ai-engineering-framework/90-agent-response-contract.md`.
...
- every LP-AI-000002 acceptance criterion;
- mandatory validation commands and exact results;
- valid and invalid review evidence fixtures;
- failure paths for invalid status-only, missing follow-up details, missing finding details and missing blocked resume condition;
- Review Evidence Engine does not collapse QA, Security or human merge gates;
...
```text
implementation/evidence/LP-AI-000002/qa.md
```
