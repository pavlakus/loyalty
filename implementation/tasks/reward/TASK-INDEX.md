...
- LP-008005 — Implement Reward Ledger persistence, RLS, and concurrency enforcement (READY_FOR_MERGE)

Order: earning decision → immutable ledger/account contracts → pending/expiration → tests/gate → persistence/RLS.
