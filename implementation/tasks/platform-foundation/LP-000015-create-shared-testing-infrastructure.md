# LP-000015. Create shared testing infrastructure

## 1. File Name

`LP-000015-create-shared-testing-infrastructure.md`
...
- `production code changes outside approved support hooks`
...
- Clock abstraction is usable.
- Tenant fixtures are deterministic.
- Concurrency helpers exist.
- Provider mocks are available.
