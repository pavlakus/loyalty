# LP-000011. Implement event dispatcher worker foundation

## 1. File Name

`LP-000011-implement-event-dispatcher-worker-foundation.md`
...
- Worker claims records atomically.
- Temporary failure retries use bounded backoff.
- Permanent failure becomes visible.
- Duplicate dispatch does not create duplicate processing records.
