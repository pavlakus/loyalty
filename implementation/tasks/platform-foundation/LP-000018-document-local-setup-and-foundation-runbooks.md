# LP-000018. Document local setup and foundation runbooks

## 1. File Name

`LP-000018-document-local-setup-and-foundation-runbooks.md`
...
- A clean machine setup path is documented.
- Database and test commands are documented.
- Troubleshooting guidance exists.
- Recovery and rollback notes exist.
