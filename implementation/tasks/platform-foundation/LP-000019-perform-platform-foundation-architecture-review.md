# LP-000019. Perform platform foundation architecture review

## 1. File Name

`LP-000019-perform-platform-foundation-architecture-review.md`
...
- Repository and dependency directions match approved architecture.
- No business logic has leaked into Foundation.
- All required ADRs are accepted or blockers are recorded.
