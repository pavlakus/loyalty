...
| LP-002012 | Design Customer anonymization strategy | TASK_PREPARATION | `agent/task-preparation/LP-002012-customer-anonymization` | Pending preparation | Depends on completed Customer architecture, contracts and profile validation; architecture-only scope does not depend on deferred LP-000009 or LP-000016. |
