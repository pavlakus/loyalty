...
| LP-003001 | Define Business aggregate | QA | `agent/qa/LP-003001-business-aggregate` | Review APPROVED; QA APPROVED | 3 focused tests pass; Security review required before merge readiness. |
