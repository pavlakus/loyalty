...
| LP-002003 | Create Customer database schema | READY | `agent/database/LP-002003-customer-schema` | Pending implementation | Preparation passed on `agent/task-preparation/LP-002003-customer-schema`; depends on LP-000009 and completed Customer contracts; RLS remains LP-002014 scope. |
