...
| LP-003003 | Create Business schema | READY | `agent/database/LP-003003-business-schema` | Pending implementation | Preparation passed; LP-000009 and LP-003001 are complete; Business RLS remains a separate follow-up. |
