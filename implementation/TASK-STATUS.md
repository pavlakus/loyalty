...
| LP-002011 | Implement Customer suspension and reactivation | TASK_PREPARATION | `agent/task-preparation/LP-002011-customer-suspension-reactivation` | Pending | Task preparation in progress; implementation is not authorized until preparation completes. |
