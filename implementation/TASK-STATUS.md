...
| LP-000006 | Implement Environment Configuration Validation | TASK_PREPARATION | `agent/task-preparation/LP-000006-environment-config` | Pending | Preparation blocked pending an approved environment variable contract; see `implementation/evidence/LP-000006/prepare.md`. |
