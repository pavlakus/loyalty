...
| LP-005005 | Define reward rule configuration | READY_FOR_MERGE | `agent/backend/LP-005005-reward-rule-configuration` | APPROVED; QA APPROVED; Security APPROVED | Deterministic minor-unit rule evaluation; focused validation passed. |
