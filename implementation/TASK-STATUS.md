...
| LP-008005 | Implement Reward Ledger persistence, RLS, and concurrency enforcement | QA | `agent/qa/LP-008005-reward-persistence` | Review approved; QA approved | PostgreSQL projection, append-only, idempotency, RLS, concurrency, and repository validation passed. |
