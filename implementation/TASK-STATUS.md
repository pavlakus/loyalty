...
| LP-004003 | Create Brand schema | IMPLEMENTATION_COMPLETE | `agent/database/LP-004003-brand-schema` | Pending independent review | Brand root migration and disposable schema assertions implemented; RLS remains a separate follow-up. |
