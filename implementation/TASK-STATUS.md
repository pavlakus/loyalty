...
| LP-002023 | Perform Customer architecture review | QA | `agent/qa/LP-002023-customer-architecture-review` | QA Agent | QA approved; architecture scope and deferred foundations verified. |
