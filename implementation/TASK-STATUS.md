...
| LP-007002 | Define Receipt API and event contracts | READY_FOR_MERGE | `agent/contracts/LP-007002-receipt-contracts` | Review, QA, and Security approved | Strict record/cancel API and Receipt event contracts added; no PII, floating-point money, or client-owned state. |
