...
| LP-003002 | Define Business API contracts | QA | `agent/qa/LP-003002-business-contracts` | Review APPROVED; QA APPROVED | 2 focused tests pass; Security review required before merge readiness. |
