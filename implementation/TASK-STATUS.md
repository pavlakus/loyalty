...
| LP-000004 | Configure Linting, Formatting and Module Boundaries | QA | `agent/devops/LP-000004-lint-format-boundaries` | REVIEW APPROVED | Independent review approved; QA validation is next. |
