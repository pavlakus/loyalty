...
| LP-005009 | Define Status Level configuration | READY_FOR_MERGE | `agent/backend/LP-005009-status-level-configuration` | APPROVED; QA APPROVED; Security APPROVED | Status configuration only; focused validation passed. |
