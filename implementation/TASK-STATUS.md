...
| LP-005014 | Implement Loyalty Program persistence and RLS | IN_PROGRESS | `agent/database/LP-005014-program-persistence` | Implementation in progress | Migration passed live PostgreSQL run `31299212274`; dedicated RLS assertions remain to be executed against PostgreSQL. |
