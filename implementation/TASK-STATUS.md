...
| LP-002007 | Implement current Customer profile query | READY_FOR_REVIEW | `agent/backend/LP-002007-customer-profile-query` | Pending independent review | Current-user profile query boundary committed at `1182387`; API contract tests and FCR validation passed; full API build/focused query test remain blocked by the known dependency baseline. |
