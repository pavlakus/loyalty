...
| LP-009004 | Add XP, Status, Benefit-reference, privacy, and security tests | READY_FOR_MERGE | `agent/qa/LP-009004-xp-status-final-gate` | Review, QA, and Security approved | XP/Status domain/application vertical validated; persistence/RLS remains deferred. |
