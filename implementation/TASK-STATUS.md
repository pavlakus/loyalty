...
| LP-006007 | Implement Membership suspension and closure operations | READY_FOR_MERGE | `agent/backend/LP-006007-membership-lifecycle-commands` | Review, QA, and Security approved | Lifecycle command validation passed; downstream behavior remains deferred. |
