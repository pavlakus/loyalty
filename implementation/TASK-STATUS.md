...
| LP-003001 | Define Business aggregate | READY |  | Task Preparation | Preparation passed; approved aggregate contract and domain-only scope are complete; implementation may begin. |
