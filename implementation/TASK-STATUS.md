...
| LP-002022 | Document Customer module and privacy runbook | REVIEW | `agent/review/LP-002022-customer-runbook` | Review Agent | Independent review approved; documentation boundaries accurate. |
