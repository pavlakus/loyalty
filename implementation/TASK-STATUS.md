...
| LP-002006 | Implement Customer profile validation | TASK_PREPARATION | `agent/task-preparation/LP-002006-customer-profile-validation` | Pending preparation | Depends on completed Customer architecture/contracts; validation-only scope does not depend on deferred LP-000009 or LP-000016. |
