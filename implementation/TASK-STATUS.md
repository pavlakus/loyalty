...
| LP-009002 | Implement deterministic XP earning and idempotency contract | READY_FOR_MERGE | `agent/backend/LP-009002-xp-earning` | Review, QA, and Security approved | Additive XP earning and duplicate prevention tests passed 2/2; persistent/distributed enforcement remains deferred. |
