...
| LP-000009 | Create Database Migration Framework | IN_PROGRESS | `agent/database/LP-000009-ci-loopback-correction` | Correction revalidation in progress | Explicit CI/test URLs must support isolated loopback services; production loopback remains rejected. |
