...
| LP-006011 | Add Membership domain, API, privacy, and security tests | READY_FOR_MERGE | `agent/qa/LP-006011-membership-tests` | Review, QA, and Security approved | Focused Membership privacy/security/domain suite passed 17/17; persistence/RLS, session runtime, and distributed production atomicity remain explicitly out of scope. |
