...
| LP-004001 | Define Brand aggregate | QA | `agent/qa/LP-004001-brand-aggregate` | Review APPROVED; QA APPROVED | 3 focused tests pass; Security review required before merge readiness. |
