...
| LP-002011 | Implement Customer suspension and reactivation | QA | `agent/qa/LP-002011-customer-suspension-reactivation` | REVIEW APPROVED; QA APPROVED; Security pending | QA completed with contract/FCR validation passing; API build and focused lifecycle test remain blocked by the known dependency baseline. |
