...
| LP-000010 | Implement Transactional Outbox Schema | IN_PROGRESS | `agent/database/LP-000010-outbox-schema` | Task Preparation complete | Outbox migration and atomic claim tests are in progress; isolated PostgreSQL validation pending. |
