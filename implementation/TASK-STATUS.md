...
| LP-007004 | Implement receipt cancellation compensating-record contract | READY_FOR_MERGE | `agent/backend/LP-007004-receipt-cancellation` | Review, QA, and Security approved | Cancellation validation passed 2/2; original Receipt remains immutable and ledger reversal remains downstream. |
