...
| LP-008004 | Add Reward earning, ledger, idempotency, and security tests | READY_FOR_MERGE | `agent/qa/LP-008004-reward-final-gate` | Review, QA, and Security approved | Reward domain/application vertical validated; persistence/RLS/distributed enforcement remains deferred. |
