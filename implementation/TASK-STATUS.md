...
| LP-002003 | Create Customer database schema | IMPLEMENTATION_COMPLETE | `agent/database/LP-002003-customer-schema` | Pending independent review | Implementation commit prepared; clean/rerun migration and Customer schema assertions pass; RLS remains LP-002014 scope. |
