...
| LP-000009 | Create Database Migration Framework | QA | `agent/review/LP-000009-ci-loopback-correction` | REVIEW APPROVED; QA in progress | Explicit CI/test URLs support isolated loopback services; development-only fallback and production safeguards remain intact. |
