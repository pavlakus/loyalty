...
| LP-008003 | Implement pending and expiration decision contracts | READY_FOR_MERGE | `agent/backend/LP-008003-reward-lifecycle` | Review, QA, and Security approved | Pending/release/expiration lifecycle tests passed 3/3; scheduler/persistence/RLS remain deferred. |
