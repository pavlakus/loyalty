...
| LP-002022 | Document Customer module and privacy runbook | QA | `agent/qa/LP-002022-customer-runbook` | QA Agent | QA approved; documentation coverage and deferred-boundary statements verified. |
