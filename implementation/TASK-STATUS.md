...
| LP-008005 | Implement Reward Ledger persistence, RLS, and concurrency enforcement | IN_PROGRESS | `agent/database/LP-008005-reward-persistence` | Implementation in progress | Task Preparation complete; implementing immutable Reward Ledger history, persisted Account projection, idempotency, tenant RLS, and atomic concurrency enforcement. |
