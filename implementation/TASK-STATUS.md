...
| LP-001009 | Implement request phone verification command | READY | `agent/task-preparation/LP-001009-otp-request` | Task Preparation Agent | Request orchestration scope prepared over existing secure ports. |
