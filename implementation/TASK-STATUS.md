...
| LP-002013 | Implement Customer anonymization command | READY_FOR_MERGE | `agent/security/LP-002013-customer-anonymization-command` | REVIEW APPROVED; QA APPROVED; SECURITY APPROVED | Security review completed; contract/FCR validation passed; API build/focused anonymization test remain blocked by the known dependency baseline. |
