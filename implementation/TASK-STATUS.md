...
| LP-007006 | Implement Receipt persistence, RLS, and transactional outbox | QA | `agent/qa/LP-007006-receipt-persistence` | Review approved; QA approved | Independent review approved; QA acceptance, tenant isolation, PostgreSQL, migration, and repository validations passed. |
