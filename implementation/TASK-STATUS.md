...
| LP-002005 | Implement verified identity Customer resolution | READY | `agent/backend/LP-002005-identity-resolution` | Pending implementation | Preparation merged; Customer resolution follows the approved Authentication→Customer boundary and anonymized-identity rules in MIP-002; deferred infrastructure tasks remain outside this product scope. |
