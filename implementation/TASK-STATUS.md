...
| LP-003003 | Create Business schema | IMPLEMENTATION_COMPLETE | `agent/database/LP-003003-business-schema` | Pending independent review | Business root migration and disposable schema assertions implemented; RLS remains a separate follow-up. |
