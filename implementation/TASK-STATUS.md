...
| LP-002023 | Perform Customer architecture review | READY_FOR_MERGE | `agent/security/LP-002023-customer-architecture-review` | Security Agent | Review, QA, Security approved; no findings. |
