...
| LP-012001 | Compose PostgreSQL-backed local MVP application vertical | TASK_PREPARATION | `agent/task-preparation/LP-012001-local-mvp-application` | Preparation complete; implementation pending | ADR-012 accepted; all persisted domain dependencies are complete; task is ready for implementation. |
