...
| LP-002008 | Implement Customer profile update command | TASK_PREPARATION | `agent/task-preparation/LP-002008-customer-profile-update` | Pending preparation | Customer-owned profile update follows the approved field contract, version/concurrency rules and privacy boundaries; deferred infrastructure tasks remain outside this product scope. |
