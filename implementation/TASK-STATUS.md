...
| LP-000004 | Configure Linting, Formatting and Module Boundaries | READY_FOR_MERGE | `agent/devops/LP-000004-lint-format-boundaries` | REVIEW APPROVED; QA APPROVED | Independent QA passed; security review and maintainer merge are next. |
