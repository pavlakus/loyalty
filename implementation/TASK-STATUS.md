...
| LP-002013 | Implement Customer anonymization command | READY | `agent/backend/LP-002013-customer-anonymization-command` | Pending | Task Preparation merged; implementation may begin on the isolated backend branch. |
